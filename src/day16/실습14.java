...
public class 실습14 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("[1] 0으로 나눌 수 없습니다." + e);
        }
        ...
        try {
            ...
            System.out.println("[2] 잘못된 숫자 형식입니다." + e);
        }
        ...
        try {
            ...
            System.out.println("[3] 잘못된 인덱스에 접근했습니다." + e);
        }
        ...
        try {
            ...
            System.out.println("[4] 객체가 초기화되지 않았습니다." + e);
        }

        // 문제 5
        try{
            System.out.println("[5] 데이터 베이스 연결을 시작합니다.");
        }finally {
            System.out.println("[5] 데이터베이스 연결을 종료합니다.");
        }
        ...
        try {
            ...
            System.out.println("[6] 객체가 없습니다." + e);
        }catch (ArithmeticException e1 ){
            System.out.println("[6] 0으로 나눌 수 없습니다." +e1);
        }

        // 문제 7
        System.out.println("1초 대기중");
        try{
            pauseOneSecond();
        }catch (InterruptedException e2 ){
            System.out.println("[7] 1초간 프로그램 일시정지" + e2);
        }
        System.out.println("1초 대기 완료");
        ...
        try{
            ...
            System.out.println("[8] 알 수 없는 오류가 발생했습니다." + e);
        }
    } // main e
} // class e
