            ...
            3. 사용법
                import : 같은 패키지가 아닌 다른 패키지의 클래스 가져오는 키워드
                    ...
                    * 단] java.lang 패키지는 예외/생략가능
                        -> System 클래스 , String 클래스 등등
        [ getter and setter ]
            1. 정의 : 클래스내 private 멤버변수를 다른 클래스가 사용할 수 있도록 하는 함수
            2. 관례적으로
                1)저장/대입 목적 : setter
                    public void set 멤버변수( 타입 매개변수 ){
                        this.멤버변수명 = 매개변수;
                 }
                2) 호출/반환 목적 : getter
