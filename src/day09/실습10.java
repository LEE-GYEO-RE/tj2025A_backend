...
public class 실습10 { // class s
    public static void main(String[] args) { // main s
        ...
        // 문제 1
        Member m1 = new Member();           // Member 객체 생성
        m1.setId("admin");                  // 수정
        System.out.println(m1.getId());     // 호출

        // 문제 2
        Score s1 = new Score();
        s1.setScore(85);        // 대입 가능
        s1.setScore(120);       // 대입 대신에 출력문

        // 문제 3
        BankAccount b1 = new BankAccount("123-456");    // "123-456" 가진 객체 생성됨
        System.out.println(b1.getAccountNumber());      // 출력
