...
public class 실습1 {
    public static void main(String[] args){ // main 함수 밖에서 함수 실행 불가능
        System.out.println( 25 );
        System.out.println( "홍길동");

        int age = 28;                       // int : 저장공간 크기 , age : 공간이름 , = : 대입 , 28 : 리터럴/자료
        System.out.println( age );          // System.out.println( 리터럴/변수호출/연산식/함수호출 가능 ); , 함수/변수 선언은 안됨.

        String name = "이겨레";              // 초기화? : 변수 선언과 동시에 값 대입
        int age2 = 28;
        double height = 163.42;
        String motto = "다 드루와";
