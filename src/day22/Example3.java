...
// [3] < T > : 제네릭 타입
// 클래스 정의할때 타입을 정하지 않고 매개로 표현
// content 변수에 String/int 처럼 타입을 정하지 않는다.
// 인스턴스 생성시 T에 대해서 타입 정한다.
// content를 언제는 String , 언제는 int로 쓰고 싶을 때
class Box< T >{
    T content;
} // class e
...
class miniArrayList< E >{
    ...
    // 제네릭 타입으로 10개까지 만들고 , E 타입으로 배열을 Object로 관리?
} // class e
    ...
    public static void main(String[] args) {
        ...
        /*
            [ 제네릭 타입 ]
                ...
                2. 목적 : 클래스 정의할 때 변수 타입을 정하지 않고 인스턴스를 생성할 때 변수의 타입을 정한다.
                ...
                4. 활용처 : 컬렉션 프레임워크 (실무중요)
                    -> ArrayList< 제네릭타입 >
                    - ArrayList 객체 , < 제네릭타입 >
                    - 객체내 여러개 요소들을 저장할 항목타입 == 제네릭타입
                5. 특징 : 변수의 타입 유연성 , 코드중복제거 , 잘못된 타입방지
                6. 주의할점 : 기본타입(8가지) 으로는 제네릭타입으로 사용불가능.
        ...
        */
        ...
        // * 뒤에 생성자에는 제네릭타입을 생략 가능

        box3.content = "자바";
        box4.content = 200;
        // * 즉] 동일한 타입내 서로 다른 멤버변수 타입을 사용 가능하다.
        ...
        System.out.println(dto.value2);
        System.out.println(dto2.value1);
        System.out.println(dto2.value2);
        System.out.println(dto3.value1);
        System.out.println(dto3.value2);
