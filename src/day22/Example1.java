    ...
    public static void main(String[] args) {
        ...
        [ String 클래스 ]
            ...
            2. 문자열 비교하는 방법
                ...
                2) 문자열A.equals(문자열B)  : "리터럴"과 객체 문자열을 비교 가능하다.
            3. 주요 메소드
        ...
        */
        ...
        // 2. char 타입의 아시크코드 10진수
        char str3 = 65;                     System.out.println(str3);   // A
        char[] str4 = { 74 , 65 ,86 ,65 };  System.out.println(Arrays.toString(str4));  // JAVA
        char str5 =  '김';                   System.out.println((int)str5);  // 44608

        // 3. 문자열 리터럴 : " " 큰따옴표 , String 클래스
        String str6 = "유재석"; // 주소값 같음                   // new String 사용하지 않고 문자열 생성할 경우
        String str7 = "유재석"; // 주소값 같음                   // 문자열이 동일할 경우 동일한 객체 취급
        String str8 = new String("유재석");//주소값 다름 // new String 사용시 동일한 문자열이라도 다른 객체 취급
        ...
        // 활용] JDBC SQL의 매개변수 연결        // 권장 : 수업때 쓴 ? 물음표 쓰셈
        String name = "유재석";
        ...
        // 활용] nextChar() [x] --> 문자 1개입력 : scan.next().charAt(0)
        ...
        // 7) .replace( 기존문자열 , 새로운문자열 ) , 전체 변경 : replaceAll ( 기존문자열 , 새로운문자열 )
        // : 지정한 문자열 내 기존문자열을 새로운 문자열로 생성후 반환 메소드 -> 주소값 바뀜
        ...
        String str13 = "012345-1230123".substring( 0 , 6 ); // 0번 인덱스 부터 6번 인덱스 전까지
        System.out.println(str13 ); // 012345
        String str14 = "012345-1230123".substring( 7 ); // 7번 인덱스부터 (자동으로)마지막인덱스까지 추출
        ...
        String[] str15 = "012345-1230123".split("-"); // "-" 하이푼 기준으로 문자열 쪼개기
        System.out.println(str15[0]); // 012345
        System.out.println(str15[1]); // 1230123
        // 활용1] CSV 형식 , CSV에서 ,(쉼표)로 속성 구분하고 , \n 으로 줄바꿈 구분한다.
        // 활용2] 날짜( 연-월-일 )
        // 활용3] 주소( 시 군 구 동 )

        // 10) .indexOf( "찾을문자열" );     : 지정한 문자열내 찾을문자열이 존재하면 찾은 인덱스 반환 , 없으면 -1 반환 메소드
        int findIndex = "자바 프로그래밍 언어".indexOf("프로");
        System.out.println(findIndex);  // 3
        // 11) .contains( "찾을문자열" )     : 지정한 문자열내 찾을문자열이 존재하면 true 업승면 false 반환 메소드
