        ...
        /*
            [ 클래스 와 객체 ]
                ...
                * 자바의 모든 코드는 클래스 단위로 컴파일 한다. *
                ...
                5) 생활속 예시
                    (1) 학생 객체 만들기
                        1. 클래스 정의   즉] 속성과 기능 정의 --> 특징 , 이벤트 만들기
                ...
                6) 사용법
                    ...
                    < 객체 내 멤버변수 값 수정 >
                        변수명.멤버변수 = 새로운 값
                    < 객체 내 멤버변수 추가 / 삭제 불가능 >
                        * 실행 도중에 클래스 정보를 수정할 수 없다. : 이미 컴파일이 됐기 때문에. 유연성 떨어짐 -> MAP 같은 거 써야함
        */
        // [1] 학생 클래스 만들기 , 학생 객체를 만들기 위한 학생 속성과 기능을 정의하는 곳
        ...
        // [8] 붕어빵 객체 만들기
            ...
            붕어빵틀 빵3 = new 붕어빵틀();
            빵3.내용물 = "슈크림";
            빵3.가격 = 1500;       // - 슈크림 붕어빵 객체 형성

            // 3) 객체와 배열의 관계 : 배열은 동일한 타입/클래스 데이터/객체를 여러개 저장
                // - 주문한 붕어빵 3개를 비닐봉지에 넣어주세요.
            붕어빵틀[ ] 빵봉지 = { 빵1 , 빵2 , 빵3 };
                // * 서로 다른 속성들을 데이터들은 *객체*로 묶어주는 게 좋음
                    // -> 객체화 , 내용물/가격  ---> 객체
                // * 서로 같은 속성/타입 들의 데이터들은 *배열*로 묶어주는게 좋음
                    // -> 배열화 , 빵1빵2빵3   ---> 배열
    } // main e
} // Example class e

class Student {             // 클래스란? 객체를 만들기 위해 객체내 필요한 속성과 기능을 설계/정의
